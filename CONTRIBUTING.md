...
Report bugs at https://github.com/zawadzkim/gensor/issues
...
The best way to send feedback is to file an issue at https://github.com/zawadzkim/gensor/issues.
...
Ready to contribute? Here's how to set up `gensor` for local development.
Please note this documentation assumes you already have `poetry` and `Git` installed and ready to go.

1. Fork the `gensor` repo on GitHub.
